...
SELECT m.id, t.id
FROM (VALUES
  ('jonas-weber-1001',      'Engineering Management'),
  ('jonas-weber-1001',      'Backend'),
  ('amara-okafor-1002',     'Backend'),
  ('amara-okafor-1002',     'System Design'),
  ('ahmed-hassan-1003',     'Mobile'),
  ('ingrid-johansson-1004', 'UX/UI Design'),
  ('sean-obrien-1005',      'DevOps/SRE'),
  ('sean-obrien-1005',      'Cloud & Infrastructure'),
  ('sean-obrien-1005',      'System Design'),
  ('priya-sharma-1006',     'UX/UI Design'),
  ('priya-sharma-1006',     'Career Growth'),
  ('yuki-tanaka-1007',      'DevOps/SRE'),
  ('elif-kaya-1008',        'Product Management'),
  ('elif-kaya-1008',        'Project Management'),
  ('daria-kovalenko-1009',  'Frontend'),
  ('daria-kovalenko-1009',  'System Design'),
  ('marco-rossi-1010',      'Machine Learning'),
  ('marco-rossi-1010',      'Data & Analytics'),
  ('lena-fischer-1011',     'People & HR'),
  ('lena-fischer-1011',     'Career Growth'),
  ('lena-fischer-1011',     'Interview Prep'),
  ('tom-baker-1012',        'QA & Test Automation'),
