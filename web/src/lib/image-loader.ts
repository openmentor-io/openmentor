// 'hero' is the alpha-transparent background-removed cutout generated by the
// cutout pipeline; the others are plain resizes of the original photo.
type ImageSize = 'full' | 'large' | 'small' | 'hero'
...
export function imageLoader({ src, width, quality, version }: ImageLoaderParams): string {
  ...
  if (quality === 'full' || quality === 'large' || quality === 'small' || quality === 'hero') {
    size = quality
  }
